...
import com.ssk.auth.domain.domain.PasswordValidationState
import com.ssk.auth.domain.domain.UserDataValidator
import com.ssk.auth.presentation.R
import com.ssk.core.presentation.designsystem.CheckIcon
import com.ssk.core.presentation.designsystem.CrossIcon
import com.ssk.core.presentation.designsystem.EmailIcon
import com.ssk.core.presentation.designsystem.Poppins
import com.ssk.core.presentation.designsystem.RuniqueDarkRed
import com.ssk.core.presentation.designsystem.RuniqueGray
import com.ssk.core.presentation.designsystem.RuniqueGreen
...
fun RegisterScreenRoot(
    ...
    ObserveAsEvents(flow = viewModel.events) { event ->
        when(event) {
            ...
            is RegisterEvents.OnRegistrationSuccess -> {
                keyboardController?.hide()
                Toast.makeText(context,
                    context.getString(R.string.registration_successful), Toast.LENGTH_LONG).show()
